...
class AuthController {
    ...
    PostRegister(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(yield SetupService_1.SetupService.GetEntity('enableRegistration')).boolValue) {
    ...
    PostRequestAccess(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (mailArr.length !== 2) {
                    return res.status(400).send(ValidationResources_1.ValidationResources.MailAddressInvalidFormat);
                }
                const domains = yield ProxmoxService_1.ProxmoxService.getDomains();
                if (domains.length === 0) {
                    return res.status(500).send(SystemResources_1.SystemResources.ServerError);
                }
                if (domains.find(x => x.domain === mailArr[1]) == null) {
                    return res.status(400).send(ValidationResources_1.ValidationResources.MailAddressNotManaged);
                }
                const secret = StringHelper_1.StringHelper.Generate(64);
