...
exports.QuarantaineAction = exports.ProxmoxService = void 0;
...
const SpamEntry_1 = require("../models/Proxmox/SpamEntry");
...
class ProxmoxService {
    ...
    static getSpamQuarantaine(retry = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.ticket == null) {
                yield this.createTicket();
                if (retry) {
            ...
            try {
                ...
                if (req.status === 200) {
                    const list = [];
                    for (const item of req.body.data) {
                        const spamEntry = new SpamEntry_1.ProxmoxSpamEntry();
    ...
    static getSpamQuarantaineByReceiver(receiver, retry = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.ticket == null) {
                yield this.createTicket();
                if (retry) {
    ...
    static getMessageFromQuarantaineById(id, retry = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.ticket == null) {
                yield this.createTicket();
                if (retry) {
    ...
    static executeQuarantaineActionById(id, action, retry = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.ticket == null) {
                yield this.createTicket();
                if (retry) {
...
var QuarantaineAction;
(function (QuarantaineAction) {
    QuarantaineAction["DELETE"] = "delete";
    QuarantaineAction["WHITE_LIST"] = "whitelist";
    QuarantaineAction["BLACK_LIST"] = "blacklist";
    QuarantaineAction["DELIVER"] = "deliver";
})(QuarantaineAction = exports.QuarantaineAction || (exports.QuarantaineAction = {}));
