...
class AuthService {
    ...
    createSession(user, ip, pubKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sessionTimeout = (yield SetupService_1.SetupService.GetEntity('sessionTimeout')).numericValue;
            ...
            session.expired_at = DateHelper_1.DateHelper.addMinutes(sessionTimeout | 10);
            if (pubKey != null) {
...
StepOne e.V.`;
            const mail = new MailService_1.MailService(user.email, 'Zurücksetzung des Passworts', message);
...
Mit freundlichen Grüßen\n
StepOne e.V.`;
            const mail = new MailService_1.MailService(user.email, 'Passwort Änderung', message);
            return yield mail.send();
        });
    }
    ...
    register(username, email, password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if ((yield SetupService_1.SetupService.GetEntity('userRequireValidMail')).boolValue) {
