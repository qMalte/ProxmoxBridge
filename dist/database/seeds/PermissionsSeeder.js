...
class PermissionsSeeder {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.createPermission('teams', 'Teams-Verwaltung');
            yield this.createPermission('settings', 'Verwaltung von Basis-Einstellungen');
            yield this.createPermission('assets', 'Asset-Management');
            yield this.createPermission('assets_signing', 'Review Assets');
            yield this.createPermission('gameServer_manage', 'Asset-Management');
        });
    }
