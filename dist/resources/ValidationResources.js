...
exports.ValidationResources = {
    ...
    MissingDomainCreationInformation: new Response_1.Response('validation_error_domain_creation', 'Um eine neue Domain anzulegen, wird ein gültiger Domainname und eine Serveradresse für einen SMTP-Server benötigt.', 'To create a new domain, a valid domain name and server address for an SMTP server is required.', ['domain', 'smtpHost']),
    DomainAlreadyExists: new Response_1.Response('validation_error_domain_already_exists', 'Die Domain ist berets im System hinterlegt.', 'The domain is already stored in the system.', []),
    MailAddressNotProvided: new Response_1.Response('validation_error_mail_address_not_provided', 'Um einen Authentifizierung-Schlüssel zu erstellen, wird eine gültige E-Mail-Adresse benötigt.', 'To create an authentication key, a valid email address is required.', ['email']),
